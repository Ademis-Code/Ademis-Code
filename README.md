I am a web programmer and an article writer, currently exploring and learning new technologies.
...
### 📬 How to reach me:
- Email: [gitscareal@gmail.com](mailto:gitscareal@example.com)
...
* Auth/Login(username: admin. Password: admin1234).
* CRUD tasks with drag-and-drop.
* Dynamic interactions using AJAX.
